...
document.querySelectorAll('.service-toggle').forEach(toggle => {
  toggle.addEventListener('click', function() {
    var targetPanel = document.getElementById(this.getAttribute('data-target'));
    var allPanels = document.querySelectorAll('.sub-services-panel');
...
document.querySelectorAll('.sub-services > li').forEach(item => {
  item.addEventListener('click', function(event) {
    event.stopPropagation();
    var nestedServices = this.querySelector('.nested-sub-services');
    if (nestedServices) {
      nestedServices.style.display = nestedServices.style.display === 'block' ? 'none' : 'block';
    }
  });
});
